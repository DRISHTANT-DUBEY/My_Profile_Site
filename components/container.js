...
export default function Container(props) {
  ...
  return (
    <div className="max-w-full bg-white dark:bg-black selection:bg-gray-800">
      ...
      <nav class="flex items-center justify-between w-full max-w-9xl p-8 mx-auto my-0 text-gray-900 bg-white sticky-nav md:my-8 dark:bg-black bg-opacity-60 dark:text-gray-100 z-10 lg:z-20">
