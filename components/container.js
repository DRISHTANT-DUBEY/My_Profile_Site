...
export default function Container(props) {
  ...
  return (
    <div className="max-w-full bg-white dark:bg-black selection:bg-gray-800">
      ...
      <nav className="flex items-center justify-between w-full max-w-9xl p-8 mx-auto my-0 text-gray-900 md:my-8 dark:text-gray-100 z-10 lg:z-20 bg-white dark:bg-black sticky-nav dark:bg-opacity-60">
